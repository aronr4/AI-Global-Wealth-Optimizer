...
import { UserPlus, Zap, Lock, Mail, User, Loader2, Shield } from 'lucide-react';
import API from '../api';
            ...
            <div className="login-hero" style={{
                ...
                <div style={{ zIndex: 1, textAlign: 'center' }}>
                    ...
                    <h1 style={{ fontSize: '3rem', color: '#fff', fontWeight: 800, marginBottom: '1rem', letterSpacing: '-1px' }}>
                        GWO<span style={{ color: '#3fb950' }}>.AI</span>
                    </h1>
                    <p style={{ fontSize: '1.2rem', color: '#8b949e', maxWidth: '400px', lineHeight: 1.6 }}>
                        Start your journey to optimized wealth. Manage your portfolio, spending, and savings all in one place.
                    </p>
                </div>
            </div>
            ...
            <div style={{
                ...
                <div style={{
                    ...
                    <div style={{ marginBottom: '2.5rem' }}>
                        <h2 style={{ margin: '0 0 0.5rem 0', fontSize: '2rem', color: '#fff', fontWeight: 700 }}>Create Account</h2>
                        <p style={{ margin: 0, color: '#8b949e', fontSize: '1rem' }}>Let's get you set up.</p>
                    </div>
                    ...
                    <form onSubmit={handleRegister} style={{ display: 'flex', flexDirection: 'column', gap: '1.2rem' }}>
                        <div>
                            <label style={{ display: 'block', marginBottom: '8px', color: '#c9d1d9', fontSize: '0.9rem', fontWeight: 500 }}>Full Name</label>
                            <div style={{ position: 'relative' }}>
                                <User size={18} color="#8b949e" style={{ position: 'absolute', top: '50%', transform: 'translateY(-50%)', left: '16px' }} />
                                <input
                                    type="text"
                        ...
                        <div>
                            <label style={{ display: 'block', marginBottom: '8px', color: '#c9d1d9', fontSize: '0.9rem', fontWeight: 500 }}>Secure Password</label>
                            <div style={{ position: 'relative' }}>
                        ...
                        <button
                            ...
                            style={{
                                ...
                                background: loading ? '#21262d' : 'linear-gradient(135deg, #3fb950 0%, #2ea043 100%)',
                                color: '#fff', border: 'none',
                                borderRadius: '12px', cursor: loading ? 'not-allowed' : 'pointer',
                                fontSize: '1rem', fontWeight: 600,
                                display: 'flex', justifyContent: 'center', alignItems: 'center', gap: '8px',
                                transition: 'all 0.2s ease',
                                boxShadow: loading ? 'none' : '0 8px 16px rgba(63, 185, 80, 0.2)'
                            }}
                            onMouseOver={e => { if (!loading) { e.currentTarget.style.transform = 'translateY(-2px)'; e.currentTarget.style.boxShadow = '0 12px 20px rgba(63, 185, 80, 0.3)'; } }}
                            onMouseOut={e => { if (!loading) { e.currentTarget.style.transform = 'none'; e.currentTarget.style.boxShadow = '0 8px 16px rgba(63, 185, 80, 0.2)'; } }}
                        >
                    ...
                    <p style={{ textAlign: 'center', fontSize: '0.9rem', color: '#8b949e', marginTop: '2.5rem' }}>
                        ...
                        <Link to="/login" style={{ color: '#3fb950', textDecoration: 'none', fontWeight: 600, transition: 'color 0.2s' }} onMouseOver={e => e.target.style.color = '#56d364'} onMouseOut={e => e.target.style.color = '#3fb950'}>
                            Authenticate
                        </Link>
                    </p>
                </div>
